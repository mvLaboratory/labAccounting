...
public class ReagentConsumptionTablePartRow implements Serializable, Savable {
    ...
    public ReagentConsumptionTablePartRow() {
    }

    public ReagentConsumptionTablePartRow(int rowID, ReagentConsumption document, int rowNumber, ReagentCatalog reagent, double quantity, double price, double sum) {
        this.rowID = rowID;
    ...
    public void setDocument(ReagentConsumption document) {
        this.document = document;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReagentConsumptionTablePartRow)) return false;

        ReagentConsumptionTablePartRow that = (ReagentConsumptionTablePartRow) o;
